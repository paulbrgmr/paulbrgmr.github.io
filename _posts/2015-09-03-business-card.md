...
gesagt zu faul die ganzen Infos einzupflegen, daher der Lorem ipsum Text. Mir ging es dabei ausschließlich um die Funktion der Seite. Daher ist das Design auch keine Glanzleistung, und responsive ist es auch nicht. - Ohne Bootstrap und den schon vordefinierten Media Queries zu viel Aufwand.  
...
GitHub: [business-card](https://github.com/paulbrgmr/business-card){:target="_blank"}